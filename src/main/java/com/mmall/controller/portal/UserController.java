...
public class UserController {
    ...
    @ResponseBody
    public ServerResponse<String> forgetGetQuestions(String username){
    ...
    @ResponseBody
    public ServerResponse<String> forgetRestPassword(String username,String passwordNew,String fogetToken){
        return iUserService.forgetRestPassword(username,passwordNew,fogetToken);
    }
